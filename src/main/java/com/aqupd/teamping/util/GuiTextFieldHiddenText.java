...
@SuppressWarnings({"unused", "UnusedReturnValue", "SuspiciousRegexArgument", "ResultOfMethodCallIgnored"})
@SideOnly(Side.CLIENT)
public class GuiTextFieldHiddenText extends Gui {
  ...
  /** If this value is true text will be hidden */
  ...
  public GuiTextFieldHiddenText(int componentId, FontRenderer fontrendererObj, int x, int y, int par5Width, int par6Height)
  {
    this.id = componentId;
  ...
  public void setHideText(boolean hidetext) { this.hideText = hidetext; }
